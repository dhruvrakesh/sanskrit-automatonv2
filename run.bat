...
echo Starting Dashboard on http://127.0.0.1:5057/
...
echo.
echo  Dashboard is running:  http://127.0.0.1:5057/
echo.
echo  To stop: close the "Sanskrit Dashboard" terminal window.
echo.
echo  To restart after a code change:
echo    python scripts\dashboard.py --inbox inbox --db data\context.db --raw data\raw --exports exports
echo.
